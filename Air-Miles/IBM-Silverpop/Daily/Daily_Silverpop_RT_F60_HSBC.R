...
#write.table(x = summDataCountry, file = paste(outputDir, "F60HSBC_Summary_by_Country.TXT", sep = "/"), row.names = FALSE, append = TRUE)
#write.table(x = summDataAct, file = paste(outputDir, "F60HSBC_Summary_by_Act.TXT", sep = "/"), row.names = FALSE, append = TRUE)
