...
baseUrl <- 'https://github.com/aliarsalankazmi/SHB_FB_App/raw/master/Data/'
source_data(paste0(baseUrl,'shbPageData.RData'))
...
shb$created_month <- paste(month(shb$created_date),year(shb$created_date), sep = '-')
